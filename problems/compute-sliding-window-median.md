# Problem: Compute Sliding Window Median

## Source
- Platform: Anki deck seed
- Topic: Heap / Priority Queue
- Tags: Heap, Median, SlidingWindow, Day14
...
How to compute sliding window median


## Brief Problem Statement

Given the problem setup, find an efficient way to compute sliding window median.
...
Use two heaps: max-heap for left half, min-heap for right half. Rebalance after each insert/remove.
