# Problem: How do we avoid duplicates in backtracking

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, Duplicates, Day11
...
Sort first. Skip duplicates using: if i>start and nums[i]==nums[i-1]: continue. Prevents repeating same branch.
