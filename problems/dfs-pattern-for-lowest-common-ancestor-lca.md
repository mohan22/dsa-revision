# Problem: DFS pattern for Lowest Common Ancestor (LCA)

## Source
- Platform: Anki deck seed
- Topic: Trees / BST
- Tags: Tree, DFS, LCA, Day12
...
Postorder recursion. if node null or node==p or node==q: return node left = dfs(left); right = dfs(right) If left and right: return node Return left or right
