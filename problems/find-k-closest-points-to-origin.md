...
Given the problem setup, find an efficient way to find K closest points to origin.

## Recognition Pattern

- Topic signal: Heap / Priority Queue
- Pattern hint from tags: Heap / Geometry
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use max-heap of size K: push (distance, point) and pop if heap > K. Distance = x^2 + y^2.
