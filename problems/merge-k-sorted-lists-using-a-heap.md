# Problem: Merge K sorted lists using a heap

## Source
- Platform: Anki deck seed
- Topic: Heap / Priority Queue
- Tags: Heap, Merge, LinkedList, Day14
...
Use k-way merge: push (value, listIndex, node) into min-heap. Pop smallest and push next node from same list.
