...
How to count connected components using DSU

## Recognition Pattern

- Topic signal: DSU
- Pattern hint from tags: DSU / Components
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Start with n components. For each edge: if find(u) != find(v): union(u,v); count -= 1 Return count.
