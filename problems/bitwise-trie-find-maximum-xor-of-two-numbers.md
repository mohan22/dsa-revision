# Problem: Bitwise trie find maximum XOR of two numbers
...
Insert numbers bitwise. For each number, try opposite bit first to maximize XOR. Build result greedily.
