# Problem: What is a Trie and why is it used

## Source
- Platform: Anki deck seed
- Topic: Trie
- Tags: Trie, PrefixTree, Day15
...
- Topic signal: Trie
- Pattern hint from tags: Trie / PrefixTree
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Trie is a prefix tree for storing characters along paths. Useful for prefix search, autocomplete, dictionary lookups. Pattern: node = root for ch in word: create child if missing; node = child node.isEnd = True
