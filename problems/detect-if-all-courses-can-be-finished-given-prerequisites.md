# Problem: Detect If All Courses Can Be Finished Given Prerequisites

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, TopologicalSort, BFS, Day9
...
- Pattern hint from tags: Graph / TopologicalSort
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Build adjacency list, compute in-degree, run BFS (Kahn’s algorithm). Cycle → impossible.
