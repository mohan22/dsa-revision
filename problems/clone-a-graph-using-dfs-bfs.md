# Problem: Clone a graph using DFS/BFS

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, DFS, Clone, Day20
...
Use map old→new. DFS: if node in map: return; create copy; recurse for neighbors. Prevents revisiting cycles.
