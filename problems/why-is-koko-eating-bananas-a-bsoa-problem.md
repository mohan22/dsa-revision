# Problem: Why is Koko Eating Bananas a BSOA problem

## Source
- Platform: Anki deck seed
- Topic: Binary Search
- Tags: BinarySearch, AnswerSearch, Koko, Day25
...
Speed is answer range. Check if mid speed works: hours += ceil(p/mid) If hours<=H: try smaller speed.
