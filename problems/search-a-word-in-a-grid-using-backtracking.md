...
How to search a word in a grid using backtracking


## Brief Problem Statement

Given the problem setup, find an efficient way to search a word in a grid using backtracking.

## Recognition Pattern

- Topic signal: Backtracking
- Pattern hint from tags: Backtracking / Grid
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

DFS from each matching cell. At each step: mark visited → explore 4 dirs → unmark. Stop when index == len(word).
