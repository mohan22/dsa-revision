# Problem: Backtracking And When Do We Use It

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, Concepts, Day11
...
- Pattern hint from tags: Backtracking / Concepts
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use DFS to build partial solutions, explore deeper, and undo choices. Pattern: 1) Choose 2) Explore (DFS) 3) Unchoose Used for subsets, permutations, combinations, valid configurations.
