...
What is the DP pattern for Longest Palindromic Substring


## Brief Problem Statement

Identify the core idea behind DP pattern for Longest Palindromic Substring and know when to apply it.

## Recognition Pattern

- Topic signal: Dynamic Programming
- Pattern hint from tags: DP / Palindrome
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Boolean DP: if s[l]==s[r] and (r-l<2 or dp[l+1][r-1]) then palindrome. Expand window size from 1→n.
