# Problem: Count ways to make amount (Coin Change 2)

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DP, Counting, Knapsack, Day17
...
- Pattern hint from tags: DP / Counting
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

dp=[0]*(amount+1); dp[0]=1 for coin in coins: for a in range(coin, amount+1): dp[a]+=dp[a-coin]
