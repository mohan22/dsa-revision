# Problem: Backtracking Framework

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, Template, Day24
...
- Pattern hint from tags: Backtracking / Template
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Template: def backtrack(index, path): if goal: result.append(path.copy()); return for candidate in choices: choose backtrack(next_state) unchoose
