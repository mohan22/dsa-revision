# Problem: Classic Binary Search Template

## Source
- Platform: Anki deck seed
- Topic: Binary Search
- Tags: BinarySearch, Template, Day25
...
- Pattern hint from tags: BinarySearch / Template
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

l=0, r=n-1 while l<=r: mid=(l+r)//2 if nums[mid]==target: return mid elif nums[mid]<target: l=mid+1 else: r=mid-1
