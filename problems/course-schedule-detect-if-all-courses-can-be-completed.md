# Problem: Course Schedule detect if all courses can be completed

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, TopoSort, CycleDetection, Day20
...
- Pattern hint from tags: Graph / TopoSort
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use topological sort: build indegree; queue nodes with indegree 0; process. If processed < n → cycle → cannot finish.
