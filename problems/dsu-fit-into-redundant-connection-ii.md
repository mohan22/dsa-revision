...
How does DSU fit into Redundant Connection II

## Recognition Pattern

- Topic signal: DSU
- Pattern hint from tags: DSU / Directed
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Detect two-parent conflict; remove one candidate edge; run DSU to check cycle. Return correct removable edge.
