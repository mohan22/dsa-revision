...
- Topic: Graph / Matrix
- Tags: PrefixSum, Matrix, HashMap, Hard, Day3
...
- Pattern hint from tags: PrefixSum / Matrix
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

For each pair of rows, compute column-wise prefix sum → reduce to 1D subarray sum = k.
