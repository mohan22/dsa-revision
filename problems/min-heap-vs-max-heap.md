...
Min-heap: get smallest element (merge lists, Dijkstra). Max-heap: get largest (kth largest, scheduling). Python heapq is min-heap → use negative values for max-heap.
