# Problem: Find Leftmost Or Rightmost Occurrence Of A Target
...
How to find leftmost or rightmost occurrence of a target


## Brief Problem Statement

Given the problem setup, find an efficient way to find leftmost or rightmost occurrence of a target.
...
Leftmost: while l<=r: mid=(l+r)//2 if nums[mid]>=target: r=mid-1 else: l=mid+1 return l Rightmost is symmetric.
