# Problem: DSU solve Accounts Merge

## Source
- Platform: Anki deck seed
- Topic: DSU
- Tags: DSU, Merge, Day22
...
How does DSU solve Accounts Merge

## Recognition Pattern

- Topic signal: DSU
- Pattern hint from tags: DSU / Merge
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Treat each email as node. Union emails in same account. Group by root → merge sorted emails.
