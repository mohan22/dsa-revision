# Problem: Count Unique Paths When Obstacles Are Present

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DynamicProgramming, 2DGrid, Day7
...
- Pattern hint from tags: DynamicProgramming / 2DGrid
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Same as Unique Paths but skip DP[i][j]=0 if obstacle; DP[i][j]=DP[i-1][j]+DP[i][j-1] otherwise.
