# Problem: Detect Cycles In Directed Vs Undirected Graphs

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, CycleDetection, Day20
...
- Pattern hint from tags: Graph / CycleDetection
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Undirected: cycle if visiting a visited node not equal to parent. Directed: use recursion stack (GRAY node → cycle).
