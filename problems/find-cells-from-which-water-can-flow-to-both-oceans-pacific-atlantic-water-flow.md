# Problem: Find cells from which water can flow to both oceans (Pacific Atlantic Water Flow)

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, DFS, Matrix, Day9
...
Run DFS from ocean borders inward; mark reachable cells for Pacific & Atlantic, then intersect.
