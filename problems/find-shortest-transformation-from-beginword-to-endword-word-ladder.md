# Problem: Find shortest transformation from beginWord to endWord (Word Ladder)

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, BFS, Strings, Day9
...
BFS with queue; at each step, change one letter and enqueue valid dictionary words.
