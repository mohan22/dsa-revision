# Problem: Deleting a node from a BST

## Source
- Platform: Anki deck seed
- Topic: Trees / BST
- Tags: BST, Delete, Day13
...
- Pattern hint from tags: BST / Delete
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Three cases: leaf → null; one child → return child; two children → replace with inorder successor, then delete successor.
