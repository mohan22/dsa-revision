# Problem: How is Edit Distance computed using DP

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DP, EditDistance, Day18
...
- Pattern hint from tags: DP / EditDistance
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

If chars equal → dp[i][j]=dp[i-1][j-1]. Else 1+min(delete, insert, replace).
