# Problem: Pattern For A Variable-Size Sliding Window

## Source
- Platform: Anki deck seed
- Topic: Two Pointers / Sliding Window
- Tags: SlidingWindow, Variable, Day23
...
- Pattern hint from tags: SlidingWindow / Variable
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

left=0 for right: expand with s[right] while constraint broken: shrink from left update answer Used for longest substring, K distinct, min window.
