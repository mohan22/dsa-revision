# Problem: Compute Diameter Of A Binary Tree

## Source
- Platform: Anki deck seed
- Topic: Trees / BST
- Tags: Tree, DFS, Diameter, Day12
...
Postorder DFS with global diameter. left = dfs(left); right = dfs(right) diameter = max(diameter, left + right) Return 1 + max(left, right)
