# Problem: We Combine Greedy With A Priority Queue

## Source
- Platform: Anki deck seed
- Topic: Greedy
- Tags: Greedy, PQ, Day16
...
When choices depend on dynamically picking best available option (task scheduler, meeting rooms). Pattern: sort tasks; use min/max-heap for next optimal choice.
