# Problem: Weighted DSU work for ratio problems

## Source
- Platform: Anki deck seed
- Topic: DSU
- Tags: DSU, Weighted, Ratios, Day22
...
How does weighted DSU work for ratio problems

## Recognition Pattern

- Topic signal: DSU
- Pattern hint from tags: DSU / Weighted
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

weight[x] means x/parent[x]. Union sets ratio consistency; find updates weights. Used in Evaluate Division.
