...
- Topic: Trees / BST
- Tags: Tree, Backtracking, DFS, PathSum, Day12
...
- Pattern hint from tags: Tree / Backtracking
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

DFS + backtracking. Add node to path → explore children → if leaf and sum matches add path → pop
