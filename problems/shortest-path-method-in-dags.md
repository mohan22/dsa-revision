# Problem: Shortest path method in DAGs

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, DAG, Topo, DP, Day21
...
- Pattern hint from tags: Graph / DAG
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Topo sort + DP: for node in topo: for nei,w: dist[nei] = min(dist[nei], dist[node] + w)
