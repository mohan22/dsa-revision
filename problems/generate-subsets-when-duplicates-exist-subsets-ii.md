# Problem: Generate subsets when duplicates exist (Subsets II)

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, Subsets, Duplicates, Day11
...
How to generate subsets when duplicates exist (Subsets II)


## Brief Problem Statement

Given the problem setup, find an efficient way to generate subsets when duplicates exist (Subsets II).
...
Sort nums. Skip duplicates: if i>start and nums[i]==nums[i-1]: continue. Then same template as Subsets.
