# Problem: BFS be used for shortest path in unweighted graphs

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, BFS, Day10
...
Because distance increases level-by-level. First reach is the shortest path.
