# Problem: K-Way Merge Pattern Using A Heap

## Source
- Platform: Anki deck seed
- Topic: Heap / Priority Queue
- Tags: Heap, Merge, Day14
...
- Pattern hint from tags: Heap / Merge
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Push first element of each list into min-heap. Pop smallest and push next element from that list. Used for merging K sorted lists/arrays.
