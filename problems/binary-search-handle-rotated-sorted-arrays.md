# Problem: Binary Search Handle Rotated Sorted Arrays

## Source
- Platform: Anki deck seed
- Topic: Binary Search
- Tags: BinarySearch, RotatedArray, Day25
...
One side is always sorted: if nums[l] <= nums[mid]: left sorted else: right sorted Check if target lies in sorted half.
