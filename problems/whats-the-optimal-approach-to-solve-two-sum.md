# Problem: What’s the optimal approach to solve Two Sum

## Source
- Platform: Anki deck seed
- Topic: Arrays / Hashing
- Tags: Arrays, Hashing, Day1
...
- Pattern hint from tags: Arrays / Hashing
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use a HashMap to store numbers and their indices; check if (target - num) exists before inserting. Time O(n), Space O(n).
