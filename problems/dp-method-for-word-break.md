# Problem: DP method for Word Break

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DP, Strings, Segmentation, Day18
...
What is the DP method for Word Break


## Brief Problem Statement

Identify the core idea behind DP method for Word Break and know when to apply it.
...
dp[0]=True. For each i, dp[i]=True if any dp[j] and s[j:i] in dict.
