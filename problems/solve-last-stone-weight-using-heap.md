# Problem: Solve Last Stone Weight using heap

## Source
- Platform: Anki deck seed
- Topic: Heap / Priority Queue
- Tags: Heap, Simulation, Day14
...
- Pattern hint from tags: Heap / Simulation
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use max-heap. Pop two largest, smash, push leftover if > 0.
