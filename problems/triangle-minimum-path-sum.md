...
What is the DP pattern for Triangle Minimum Path Sum


## Brief Problem Statement

Identify the core idea behind DP pattern for Triangle Minimum Path Sum and know when to apply it.

## Recognition Pattern

- Topic signal: Dynamic Programming
- Pattern hint from tags: DP / Triangle
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Bottom-up: dp[j] = triangle[i][j] + min(dp[j], dp[j+1]). Space optimized.
