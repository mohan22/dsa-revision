# Problem: Design a stack that supports retrieving the min element in O(1)

## Source
- Platform: Anki deck seed
- Topic: Stack
- Tags: Stack, Design, Day4
...
- Topic signal: Stack
- Pattern hint from tags: Stack / Design
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Maintain an auxiliary stack to store the current min at each push. Pop both stacks together.
