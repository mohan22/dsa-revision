# Problem: Solve Walls and Gates using BFS

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, BFS, Grid, Day20
...
Multi-source BFS from all gates (0). Fill each empty room with nearest gate distance. BFS ensures minimal distance.
