# Problem: Prune Branches In Backtracking

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, Pruning, Day24
...
- Pattern hint from tags: Backtracking / Pruning
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Stop early if condition impossible: - sum > target (Combination Sum) - mismatch in Word Search - skip duplicates - insufficient remaining elements Pruning reduces search space.
