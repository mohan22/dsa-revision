# Problem: Determine If A Graph Is A Valid Tree

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, DFS, TreeCheck, Day20
...
Must be connected and acyclic. DFS: if revisit node not parent → cycle. After DFS, all nodes must be visited.
