# Problem: Initialize the DP table for grid problems

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DP, Grid, BaseCase, Day19
...
Top-left starts DP. First row only from left; first column only from above. dp[0][0] = base. for j: dp[0][j] = dp[0][j-1] for i: dp[i][0] = dp[i-1][0]
