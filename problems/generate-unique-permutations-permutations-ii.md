# Problem: Generate unique permutations (Permutations II)

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, Permutations, Duplicates, Day11
...
Sort nums. Skip duplicates: if i>0 and nums[i]==nums[i-1] and not used[i-1]: continue. Use used[] + permutation pattern.
