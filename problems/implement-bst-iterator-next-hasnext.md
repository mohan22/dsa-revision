# Problem: Implement BST Iterator (next + hasNext)

## Source
- Platform: Anki deck seed
- Topic: Trees / BST
- Tags: BST, Iterator, Stack, Day13
...
- Pattern hint from tags: BST / Iterator
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use stack to store leftmost path. next(): pop, then push left path of right child. Amortized O(1).
