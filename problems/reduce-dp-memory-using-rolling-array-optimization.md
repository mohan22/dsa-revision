# Problem: Reduce DP memory using rolling array optimization

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DP, Optimization, Day17
...
- Pattern hint from tags: DP / Optimization
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

If dp[i] depends only on few previous, use variables or 1D array. Example: prev2, prev1 → curr.
