# Problem: Compute maximum XOR with constraints/queries

## Source
- Platform: Anki deck seed
- Topic: Trie
- Tags: Trie, Bitwise, XOR, Queries, Day15
...
Use bitwise Trie. Insert numbers <= query limit. Query by choosing opposite bit first. Often solved with offline sorting.
