# Problem: Compute Maximum Depth Of A Binary Tree

## Source
- Platform: Anki deck seed
- Topic: Trees / BST
- Tags: Tree, DFS, Depth, Day12
...
How to compute maximum depth of a binary tree


## Brief Problem Statement

Given the problem setup, find an efficient way to compute maximum depth of a binary tree.
...
DFS using height template. If node null: return 0 Return 1 + max(left depth, right depth)
