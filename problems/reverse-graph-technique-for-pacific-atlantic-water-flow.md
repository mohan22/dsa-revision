# Problem: Reverse graph technique for Pacific Atlantic Water Flow

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, DFS, ReverseThinking, Day20
...
- Pattern hint from tags: Graph / DFS
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Instead of flowing from land to oceans, run DFS/BFS from oceans inward. Mark reachability for Pacific and Atlantic separately and intersect.
