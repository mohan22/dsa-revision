# Problem: What is recursion tree thinking in backtracking

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, RecursionTree, Day24
...
- Pattern hint from tags: Backtracking / RecursionTree
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Visualize each choice as branch and each depth as decision step. Helps identify base case, pruning, and building solutions.
