# Problem: Hashmap Frequency Inside A Sliding Window

## Source
- Platform: Anki deck seed
- Topic: Two Pointers / Sliding Window
- Tags: SlidingWindow, HashMap, Day23
...
- Pattern hint from tags: SlidingWindow / HashMap
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

When constraints depend on frequency of elements. Used for min window substring, longest repeating char replacement, K distinct.
