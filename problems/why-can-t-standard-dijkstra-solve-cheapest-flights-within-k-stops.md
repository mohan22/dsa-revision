# Problem: Why can't standard Dijkstra solve Cheapest Flights Within K Stops

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, BellmanFord, KStops, Day21
...
Must limit number of edges (stops). Use Bellman-Ford for K+1 iterations to relax edges with stop constraint.
