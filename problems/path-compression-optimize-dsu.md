# Problem: Path compression optimize DSU

## Source
- Platform: Anki deck seed
- Topic: DSU
- Tags: DSU, PathCompression, Day22
...
- Topic signal: DSU
- Pattern hint from tags: DSU / PathCompression
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Flatten tree during find: if parent[x] != x: parent[x] = find(parent[x]) Leads to amortized α(n) time.
