# Problem: Recursive template for insert/delete in BST

## Source
- Platform: Anki deck seed
- Topic: Trees / BST
- Tags: BST, Insert, Delete, Day13
...
- Pattern hint from tags: BST / Insert
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Insert: recurse left/right until null, then create node. Delete cases: no child → null; one child → return child; two children → replace with inorder successor.
