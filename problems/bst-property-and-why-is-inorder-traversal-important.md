# Problem: BST property and why is inorder traversal important

## Source
- Platform: Anki deck seed
- Topic: Trees / BST
- Tags: BST, DFS, Inorder, Day13
...
- Pattern hint from tags: BST / DFS
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

BST rule: left < node < right. Inorder traversal yields strictly increasing values. Used for BST validation, kth smallest, and sorted extraction.
