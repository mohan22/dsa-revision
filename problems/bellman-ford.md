...
Decide when should you use Bellman-Ford and what problem signals justify that choice.
...
When graph contains negative edges or to detect negative cycles. O(V·E).
