# Problem: A 'Start Index' In Backtracking
...
Used in combinations/subsets to avoid reusing earlier elements. Template: for i in range(start,n): choose → dfs(i+1) → unchoose.
