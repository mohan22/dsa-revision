# Problem: Avoid Duplicates In Backtracking

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, Duplicates, Day24
...
How do you avoid duplicates in backtracking


## Brief Problem Statement

Given the problem setup, determine how to avoid duplicates in backtracking.

## Recognition Pattern

- Topic signal: Backtracking
- Pattern hint from tags: Backtracking / Duplicates
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Sort input. Skip duplicates at same recursion level: if i>start and nums[i]==nums[i-1]: continue Used in Subsets II and Combination Sum II.
