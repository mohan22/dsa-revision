# Problem: What data structure helps group anagrams efficiently

## Source
- Platform: Anki deck seed
- Topic: Arrays / Hashing
- Tags: Hashing, Strings, Day1
...
- Pattern hint from tags: Hashing / Strings
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

HashMap with key = sorted word or frequency tuple. Group all words by that key.
