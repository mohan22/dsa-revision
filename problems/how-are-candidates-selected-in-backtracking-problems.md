# Problem: How are candidates selected in backtracking problems

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, Candidates, Day24
...
- Pattern hint from tags: Backtracking / Candidates
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Depends on problem: - Subsets: next element - Permutations: any unused element - Combination Sum: current or next - Word Search: 4 directions Good backtracking defines candidate set clearly.
