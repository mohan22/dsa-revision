# Problem: How do frequency maps combine with heaps for Top-K problems

## Source
- Platform: Anki deck seed
- Topic: Heap / Priority Queue
- Tags: Heap, Frequency, Day14
...
- Pattern hint from tags: Heap / Frequency
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Build freq map. Push (freq, value) into min-heap of size K. If heap > K → pop smallest. Gives O(N log K) performance.
