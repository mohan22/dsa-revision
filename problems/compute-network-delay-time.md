# Problem: Compute Network Delay Time

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, Dijkstra, Day10
...
How to compute Network Delay Time


## Brief Problem Statement

Given the problem setup, find an efficient way to compute Network Delay Time.
...
Run Dijkstra; answer = max distance; unreachable → -1.
