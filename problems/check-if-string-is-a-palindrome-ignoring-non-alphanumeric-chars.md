# Problem: Check If String Is A Palindrome Ignoring Non-Alphanumeric Chars

## Source
- Platform: Anki deck seed
- Topic: Two Pointers / Sliding Window
- Tags: TwoPointers, Strings, Day2
...
How to check if string is a palindrome ignoring non-alphanumeric chars


## Brief Problem Statement

Given the problem setup, find an efficient way to check if string is a palindrome ignoring non-alphanumeric chars.

## Recognition Pattern

- Topic signal: Two Pointers / Sliding Window
- Pattern hint from tags: TwoPointers / Strings
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use two pointers from both ends, skip invalid chars, compare lowercase chars. O(n).
