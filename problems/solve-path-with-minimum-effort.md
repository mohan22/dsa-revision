# Problem: Solve Path With Minimum Effort

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, Dijkstra, Grid, Day21
...
Given the problem setup, find an efficient way to solve Path With Minimum Effort.
...
Use Dijkstra where edge weight = abs(height diff). Path cost = max edge along path.
