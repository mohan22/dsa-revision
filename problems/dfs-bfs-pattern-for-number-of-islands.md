# Problem: DFS/BFS pattern for Number of Islands

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, DFS, Grid, Day20
...
For each land cell, increment count; DFS/BFS to mark connected land as visited. Explore 4 directions.
