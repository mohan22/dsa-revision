...
Use 2D DP where dp[i][j] relates prefixes s1[0..i-1] and s2[0..j-1]. Base cases fill first row/column. Transitions compare chars. Used in LCS, Edit Distance, Distinct Subsequences.
