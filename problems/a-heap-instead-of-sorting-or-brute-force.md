# Problem: A Heap Instead Of Sorting Or Brute Force
...
- Pattern hint from tags: Heap / PQ
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use a heap when you repeatedly need smallest/largest values, top-K items, streaming values, or k-way merging. Min-heap → smallest first; Max-heap → largest first.
