# Problem: Find First And Last Occurrence Of A Target In Sorted Array
...
Use two binary searches — one for left bound, one for right bound (modify mid comparisons).
