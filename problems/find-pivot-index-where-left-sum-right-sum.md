# Problem: Find Pivot Index Where Left Sum == Right Sum

## Source
- Platform: Anki deck seed
- Topic: Arrays / Hashing
- Tags: PrefixSum, Arrays, Day3
...
Precompute total sum. Iterate, track left sum; if left == total - left - nums[i], that’s pivot. O(n).
