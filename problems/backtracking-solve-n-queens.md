# Problem: Backtracking solve N-Queens

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, NQueens, Day11
...
- Pattern hint from tags: Backtracking / NQueens
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Place queens row by row. Check conflicts using column, diag1 (r-c), diag2 (r+c). Choose column → dfs(next row) → unchoose.
