# Problem: What pattern is used to compare two trees or check subtree structures

## Source
- Platform: Anki deck seed
- Topic: Trees / BST
- Tags: Tree, DFS, Compare, Day12
...
Recursive structural comparison: if both null → True if one null or values differ → False return isSame(a.left, b.left) and isSame(a.right, b.right)
