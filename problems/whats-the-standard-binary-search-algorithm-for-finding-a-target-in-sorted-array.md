# Problem: What’s the standard binary search algorithm for finding a target in sorted array
...
Use left = 0, right = n-1, while loop, compare mid, move left/right accordingly. Return index or -1. O(log n).
