# Problem: Bellman-Ford recurrence used for

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, BellmanFord, Day21
...
Relax edges n-1 times: dist[v] = min(dist[v], dist[u] + w) Detect negative cycles with one more relaxation.
