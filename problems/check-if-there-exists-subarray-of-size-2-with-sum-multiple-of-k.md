...
- Tags: PrefixSum, Modulo, HashMap, Day3
...
- Pattern hint from tags: PrefixSum / Modulo
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Store remainders of prefix sums (sum % k). If same remainder appears again (≥2 apart), subarray sum is multiple of k.
