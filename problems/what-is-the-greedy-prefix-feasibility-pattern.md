# Problem: What is the greedy prefix feasibility pattern

## Source
- Platform: Anki deck seed
- Topic: Greedy
- Tags: Greedy, Prefix, Day16
...
- Topic signal: Greedy
- Pattern hint from tags: Greedy / Prefix
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Feasibility depends on prefix conditions (e.g., gas station, jump game). Track cumulative condition; reset when invalid prefix occurs.
