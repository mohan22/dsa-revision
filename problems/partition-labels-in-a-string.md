# Problem: Partition Labels In A String

## Source
- Platform: Anki deck seed
- Topic: Greedy
- Tags: Greedy, Strings, Day16
...
- Topic signal: Greedy
- Pattern hint from tags: Greedy / Strings
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Track last index of each char. Expand segment until farthest last occurrence. Cut segment and continue.
