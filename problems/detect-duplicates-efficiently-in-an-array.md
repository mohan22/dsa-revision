# Problem: Detect Duplicates Efficiently In An Array
...
- Pattern hint from tags: Arrays
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use a HashSet — if a number already exists in the set, return true. O(n) time, O(n) space.
