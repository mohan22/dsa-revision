# Problem: Find The Longest Word In Dictionary Where All Prefixes Exist

## Source
- Platform: Anki deck seed
- Topic: Trie
- Tags: Trie, Strings, Day15
...
- Topic signal: Trie
- Pattern hint from tags: Trie / Strings
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Insert words into Trie. Check words where every prefix node.isEnd=True. Track longest and lexicographically smallest.
