# Problem: What’s the idea behind Minimum Window Substring problem

## Source
- Platform: Anki deck seed
- Topic: Two Pointers / Sliding Window
- Tags: SlidingWindow, Strings, Hard, Day2
...
- Pattern hint from tags: SlidingWindow / Strings
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Maintain counts of target chars. Expand right pointer to include, then contract left while window is valid. Keep smallest valid window.
