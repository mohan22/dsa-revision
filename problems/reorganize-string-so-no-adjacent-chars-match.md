# Problem: Reorganize String So No Adjacent Chars Match

## Source
- Platform: Anki deck seed
- Topic: Heap / Priority Queue
- Tags: Heap, Greedy, Day14
...
- Pattern hint from tags: Heap / Greedy
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use max-heap of frequencies. Repeatedly extract top two chars, append, decrement, and reinsert.
