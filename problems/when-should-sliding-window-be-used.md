# Problem: When should sliding window be used

## Source
- Platform: Anki deck seed
- Topic: Two Pointers / Sliding Window
- Tags: SlidingWindow, Concept, Day23
...
- Pattern hint from tags: SlidingWindow / Concept
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Use sliding window when problem involves contiguous subarrays/ substrings and constraints can be checked incrementally. Types: fixed window (size k), variable window (expand-shrink).
