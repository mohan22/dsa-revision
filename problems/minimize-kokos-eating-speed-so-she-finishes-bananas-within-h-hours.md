# Problem: Minimize Koko’s eating speed so she finishes bananas within h hours

## Source
- Platform: Anki deck seed
- Topic: Binary Search
- Tags: BinarySearch, Math, Day5
...
- Pattern hint from tags: BinarySearch / Math
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Binary search on speed from 1 to max(piles). Check if speed feasible using ceil division.
