# Problem: Find top k frequent elements in O(n) time

## Source
- Platform: Anki deck seed
- Topic: Arrays / Hashing
- Tags: Hashing, Heap, Day1
...
- Pattern hint from tags: Hashing / Heap
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Count with HashMap, then use Bucket Sort to collect from highest to lowest frequency.
