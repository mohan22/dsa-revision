# Problem: Determine if you can reach the last index (Jump Game)

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DynamicProgramming, Greedy, Day6
...
- Pattern hint from tags: DynamicProgramming / Greedy
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Track max reachable index while iterating; if i > maxReach → false. O(n).
