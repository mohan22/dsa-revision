# Problem: BFS compute shortest path in unweighted graphs

## Source
- Platform: Anki deck seed
- Topic: Graph / Matrix
- Tags: Graph, BFS, ShortestPath, Day20
...
- Pattern hint from tags: Graph / BFS
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

BFS explores in levels. First time a node is reached → shortest path. queue=[(start,0)]; explore neighbors level by level.
