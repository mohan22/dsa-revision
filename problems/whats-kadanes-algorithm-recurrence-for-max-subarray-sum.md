# Problem: What’s Kadane’s algorithm recurrence for max subarray sum

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DynamicProgramming, Arrays, Day6
...
- Pattern hint from tags: DynamicProgramming / Arrays
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

DP[i] = max(nums[i], nums[i] + DP[i-1]). Track max. O(n) time.
