# Problem: Convert recurrence into bottom-up DP table

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DP, Tabulation, Day17
...
- Pattern hint from tags: DP / Tabulation
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Identify base → fill dp[0], dp[1] For i increasing: dp[i] = combine(dp[i-1], dp[i-2], ...) Answer = dp[n]
