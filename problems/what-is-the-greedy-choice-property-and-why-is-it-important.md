# Problem: What is the Greedy Choice Property and why is it important

## Source
- Platform: Anki deck seed
- Topic: Greedy
- Tags: Greedy, Concepts, Day16
...
- Topic signal: Greedy
- Pattern hint from tags: Greedy / Concepts
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Greedy works when locally optimal choices lead to a globally optimal solution. Used in intervals, scheduling, jump game, resource allocation.
