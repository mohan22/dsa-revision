# Problem: Memoization (top-down DP) pattern

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DP, Memoization, Day17
...
- Pattern hint from tags: DP / Memoization
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Recursion + cache: if state in memo → return memo[state] compute using dfs(next_state) store & return memo[state]
