# Problem: Distribute Candies Based On Ratings

## Source
- Platform: Anki deck seed
- Topic: Greedy
- Tags: Greedy, Arrays, Day16
...
How to distribute candies based on ratings


## Brief Problem Statement

Given the problem setup, find an efficient way to distribute candies based on ratings.

## Recognition Pattern

- Topic signal: Greedy
- Pattern hint from tags: Greedy / Arrays
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Two-pass greedy: Left→Right: +1 when rating increases. Right→Left: ensure right neighbor rule. Final = max(left[i], right[i]).
