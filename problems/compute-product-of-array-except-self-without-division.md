...
- Tags: Arrays, PrefixProduct, Day1
...
- Pattern hint from tags: Arrays / PrefixProduct
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Multiply prefix products (left pass) and suffix products (right pass). Two passes, O(n) time, O(1) extra space.
