# Problem: Why combine Trie + DFS in word search problems

## Source
- Platform: Anki deck seed
- Topic: Trie
- Tags: Trie, DFS, Grid, Day15
...
- Topic signal: Trie
- Pattern hint from tags: Trie / DFS
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Trie prunes invalid prefixes early. Pattern: build Trie, DFS board, follow Trie nodes, stop when prefix invalid. Enables efficient multi-word board search.
