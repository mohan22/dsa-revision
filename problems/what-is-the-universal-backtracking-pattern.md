# Problem: What is the universal backtracking pattern

## Source
- Platform: Anki deck seed
- Topic: Backtracking
- Tags: Backtracking, Template, Day11
...
result=[]; dfs(path): add if valid; for each choice: choose → dfs → unchoose. Works for permutations, subsets, N-Queens, etc.
