# Problem: Solve Partition Equal Subset Sum

## Source
- Platform: Anki deck seed
- Topic: Dynamic Programming
- Tags: DP, Knapsack, Boolean, Day17
...
Given the problem setup, find an efficient way to solve Partition Equal Subset Sum.
...
Reduce to 0/1 knapsack for sum=total//2. dp=[False]*(target+1); dp[0]=True for n in nums: for t in reversed(range(n, target+1)): dp[t]|=dp[t-n]
