# Problem: Interval Problems Usually Solved By Sorting By End Time
...
Sorting by end time ensures earliest finish → maximizes remaining room. Template: sort by end; pick interval if start >= current_end.
