# Problem: What is Binary Search on Answer (BSOA)

## Source
- Platform: Anki deck seed
- Topic: Binary Search
- Tags: BinarySearch, AnswerSearch, Day25
...
- Pattern hint from tags: BinarySearch / AnswerSearch
- Use this note to reconstruct the full solution before promoting it to Tier 1.

## Core Insight

Search on range of answers, not indices. Requires monotonic condition. Template: while l<r: mid=(l+r)//2 if can(mid): r=mid else: l=mid+1
